...
ORACLE_ANSWERS = [ORACLE_ANSWER_REPUTATION, ORACLE_ANSWER_MAJORITY_VOTING, ORACLE_ANSWER_RANDOM, ORACLE_ANSWER_GROUND_TRUTH]
...
EXPERTISES = [VERY_HIGH_EXPERTISE, HIGH_EXPERTISE, MEDIUM_EXPERTISE]
