...
ORACLE_SIZES = [ORACLE_SIZE_LARGE, ORACLE_SIZE_SMALL, ORACLE_SIZE_MEDIUM]
...
RATINGS_PERMUTATIONS = [WITHOUT_RATING, WITH_RATING]
...
#EXPERTISES = [LOW_EXPERTISE, MEDIUM_EXPERTISE, HIGH_EXPERTISE, RANDOM_EXPERTISE]
EXPERTISES = [HIGH_EXPERTISE]
